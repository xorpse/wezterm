...
impl super::TermWindow {
    ...
    pub fn apply_dimensions(
        ...
        let insets_v = (insets.top + insets.bottom) as usize;
        let insets_h = (insets.left + insets.right) as usize;
        ...
        let (size, dims, ri_calc) = if let Some(cell_dims) = scale_changed_cells {
            ...
            let ri_calc = ResizeIncrementCalculator {
                ...
                padding_right: padding_right + insets_h,
                padding_bottom: padding_bottom,
                border: border,
                tab_bar_height: insets_v,
            };
